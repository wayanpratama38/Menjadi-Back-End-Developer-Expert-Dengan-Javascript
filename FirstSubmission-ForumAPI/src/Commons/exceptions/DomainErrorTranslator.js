...
DomainErrorTranslator._directories = {
  ...
  'NEW_REPLY.NOT_MEET_DATA_TYPE_SPECIFICATION' : new InvariantError('tidak dapat membalas komen karena tipe data tidak sesuai'),
  'NEW_REPLY.NOT_CONTAIN_NEEDED_PROPERTY' : new InvariantError('tidak dapat membuat komen baru karena properti yang dibutuhkan tidak ada'),
